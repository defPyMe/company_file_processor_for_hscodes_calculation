...
#BLOUSE SOLO DONNA 
    ...
    if value[1] =="Woven" and value[2] == "W" and (value[3].lower()) in ["shirt", "blouse", "denim shirt", "polo shirt", "top"]:#ok
       first_two = "6206"
    ...
    elif value[1] in ["Woven", "-"] and value[2]=="M" and (value[3].lower()) in ["shirt", "denim shirt"]:
