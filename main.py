...
full_dataset = process_the_doc(r"C:\Users\cavazzinil\Dropbox\hs_codes_calculator\all_excel_files\Copy of C8 PRIO2 Da Calcolare.xlsx")
#print(full_dataset)
...
all_results = [suits, dress, footwear, jewellery, topwear,  bag]

for i in all_results:
    writing_to_file_f(r"C:\Users\cavazzinil\Dropbox\hs_codes_calculator\all_excel_files\balances.xlsx", i)